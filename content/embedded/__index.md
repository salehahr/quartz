...
## Math
* [Bits and bytes](embedded/bits-and-bytes.md)
* [Bin-hex-dec table](embedded/bin-hex-dec-table.md)
* [Bit logic](embedded/bit-logic.md)
* [Integer overflow](embedded/integer-overflow.md)

## Basics
* [Microcontroller](embedded/microcontroller.md)
...
## Resources
* [Miro Samek - Modern Embedded Systems Programming Course](bibliography/samek-embedded.md)
* [embedded.fm - ESE 101](bibliography/ese-101.md)
